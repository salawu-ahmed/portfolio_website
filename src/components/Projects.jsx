  ...
  return (
    <main className='flex gap-12 items-start'>
      ...
      <section className='grow '>
        <article className='border border-card-border/30 hover:border-custom-blue transition-all duration-300 max-w-64 rounded-l hover:rotate-1 hover:cursor-pointer hover:scale-105'>
